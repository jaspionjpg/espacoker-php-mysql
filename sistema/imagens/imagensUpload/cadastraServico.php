...
$serv_ent->Insert($serv);

echo "<script type='text/javascript' language='javascript'> window.location.href='http://localhost/batata/sistema/paginaServicos.php?i=sucess'; </script>";
